//! Status bar using Zed UI components and layer shell.
//!
//! This is the migrated version of the bar that uses the widget registry
//! and Zed's theme API (`cx.theme().colors()`).
...
/// Open the bar with default configuration on all displays.
    ...
    cx.spawn(async move |cx| {
        ...
        cx.update(|cx: &mut App| {
            ...
            if displays.is_empty() {
                ...
                open_with_config(services.clone(), BarConfig::default(), None, cx);
            } else {
