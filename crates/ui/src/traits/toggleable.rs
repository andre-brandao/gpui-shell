/// Elements with two or three visual states: checkboxes, toggle buttons,
...
impl ToggleState {
    ...
    /// Summarize a group of children: all checked -> selected, none ->
    /// unselected, mixed -> indeterminate.
